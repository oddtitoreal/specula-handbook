...
- **Chi guida un'organizzazione** — e vuole un processo strutturato, non una consulenza opaca.
- **Consulenti, designer, brand strategist** — che vogliono adottare Specula nei propri processi.
- **Studenti e ricercatori** — che vogliono studiare il metodo in forma operativa, indipendentemente dal libro.
