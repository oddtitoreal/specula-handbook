---
title: "Caso studio: Il posto delle fragole"
description: "Come il metodo Specula ha costruito un sistema di governance dell'identità per uno spazio di comunità a Pesaro."
---

Il metodo applicato a un caso reale, documentato e verificabile: uno spazio di comunità per giovani nel quartiere San Martino di Pesaro, costruito da quattro organizzazioni partner (ARCI, APS LiberaMusica, Cooperativa Labirinto, Fondazione Wanda di Ferdinando). Periodo: ottobre 2025 – febbraio 2026.
...
**Materiale grezzo.** Tre workshop di co-design facilitati da Sineglossa hanno prodotto nove cluster di valori e un collage collettivo le cui metafore (la farfalla, il fungo, la casa con finestra) si sono rivelate più durature di qualsiasi dichiarazione esplicita.
...
La versione integrale, con i dettagli di ogni fase e i documenti prodotti:

- [Case study completo (IT)](https://github.com/oddtitoreal/specula-method/blob/main/case-studies/case_study_posto_delle_fragole.it.md)
- [Full case study (EN)](https://github.com/oddtitoreal/specula-method/blob/main/case-studies/case_study_posto_delle_fragole.md)

---

*Facilitazione co-design: Sineglossa · Identità di brand e sintesi strategica: Specula Future Crafting*
